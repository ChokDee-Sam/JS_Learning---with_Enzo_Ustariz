...
//     // prend les infos de html data
//     let buttonValue = e.target.getAttribute("data-action");

//     // Évite les multiples zéro dans l'objet
//     if (calculatorData.calculation === "0") calculatorData.calculation = "";

//     // Envoie l'information issue du click dans l'objet
//     calculatorData.calculation += buttonValue;
//     // Affichage cette info d'objet dans l'affichage de la calculatrice
...
// // -------------------------------------------------
// // RECODER LA MÉTHODE EVAL()    (car pas sécurisé)
// // -------------------------------------------------
    ...
    switch (operator) {
        case "+":
            currentCalculationResult =
                Number(operandsInfo.leftOperand) +
                Number(operandsInfo.rightOperand);
            break;
        case "-":
            currentCalculationResult =
                Number(operandsInfo.leftOperand) -
...
function clearEntry() {
    if (!calculatorData.displayedResults) {
        if (resultDisplay.textContent[0] === "0") return;
            ...
            calculatorData.calculation = calculatorData.calculation.slice(
                0,
                -1
            );
        }
