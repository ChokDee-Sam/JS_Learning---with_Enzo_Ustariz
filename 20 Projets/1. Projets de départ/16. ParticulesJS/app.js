...
const ctx = canvas.getContext("2d"); // donne accès à des méthodes
...
class Particle {
    ...
    // Update quand ça rencontre un coté de l'écran (du canvas)
    update() {
...
function cleanDirection() {
    ...
    if (random) {
        // de 0.5 à 1.5 non inclus, non trunc [0.5,1.5[
        return Math.random() * 1 + 0.5;
    } else {
        // de -0.5 à -1.5 non inclus, non trunc ]-1.5,-0.5]
        return Math.random() * -1 - 0.5;
    }
}
